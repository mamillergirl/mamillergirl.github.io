  ...
  return (
    <div id="projects" className="mt-20 flex flex-col items-center justify-center w-full">
      ...
      <div className="mt-4 flex flex-col items-center">
        <Project source={foodDiaryApp} alt="Food Diary App" type="Mobile App" title="Food Diary App" description="The Food Diary App, I solely designed and developed as my senior project, is a cross-platform tool for tracking food intake and symptoms. Built with React Native, it offers logging of meals and symptoms and insights on food intake providing users with informationt to make better food choices. It utilizes Firebase for secure data storage and authentication, and integrates with the Edamam API for valuable food information." link="" repository="https://github.com/mamillergirl/food-diary-app" />
