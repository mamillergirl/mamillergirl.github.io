...
export default function Home() {
  return (
    ...
    <div className="flex justify-evenly w-1/6 mb-4 ">
      ...
      <h2 className="mt-4 text-center text-white text-[55px] font-extrabold ">Hi! I'm <span className="text-accentColor">Marisa</span></h2>
