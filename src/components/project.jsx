...
const Project = ({
  ...
  return (
    <div className="flex justify-center mb-10">
      <div className="sm:grid sm:grid-cols-2 sm:grid-rows-1 flex flex-col sm:w-[75%]">
        {source !== "" && (
          <div className="relative mt-7 mb-10 group pl-4">
            <img
            ...
            <div className="absolute inset-0 rounded-2xl z-10 hidden group-hover:flex lg:hidden justify-center bg-black bg-opacity-80 ">
              {link !== "" && (
                ...
                >
                  ...
                  <p className="pl-2 text-[18px]">Visit Website</p>
                </a>
              )}
              <a
              ...
              >
                ...
                <p className="pl-2 text-[18px]">View Repository</p>
              </a>
            </div>
          </div>
        )}
        <div className="flex flex-col justify-between p-8">
          <div className="">
            <h2 className="text-white text-[18px] font-extrabold">{type}</h2>
            <h1 className="text-white text-[25px] font-extrabold">{title}</h1>
            <p className="text-white  opacity-70  text-[18px]">{description}</p>
          </div>
